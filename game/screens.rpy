...
screen navigation():
    ...
    vbox:
        ...
        if _in_replay:
            ...
            textbutton _("ZakoŃcz powtÓrke") action EndReplay(confirm=True)

        elif not main_menu:

            textbutton _("Menu glÓwne") action MainMenu()
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %d.%m.%Y, %H:%M"), empty=_("Puste miejsce")):
...
screen keyboard_help():
    ...
    hbox:
        label _("Strzalki")
        text _("Poruszanie sie po interfejsie.")
    ...
    hbox:
        label _("Strona w gÓre")
        text _("Wraca do wczeŚniejszego dialogu.")

    hbox:
        label _("Strona w dÓl")
...
screen mouse_help():
    ...
    hbox:
        label _("KÓlko myszy w gÓre")
        text _("Wraca do wczeŚniejszego dialogu.")

    hbox:
        label _("KÓŁko myszy w dÓl")
        text _("Przechodzi do pÓŹniejszego dialogu.")
